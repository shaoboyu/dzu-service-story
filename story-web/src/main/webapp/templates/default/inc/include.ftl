<meta property="mtons:story" content="2.2.1">
${site_metas}
...
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" href="${base}/static/default/images/ico.png"/>
<link rel="shortcut icon" href="${base}/static/default/images/ico.png"/>
