package story.core.hook.interceptor.desk;

import story.core.hook.interceptor.InterceptorHookSupport;
...
public class ChannelControllerHook extends InterceptorHookSupport {
    ...
    public String[] getInterceptor() {
        //说明要拦截的controller
        return new String[]{"story.web.controller.desk.ChannelController"};
    }
